...
public class ListWisata extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mDatabase = FirebaseDatabase.getInstance().getReference().child(Constants.FIREBASE_CHILD_TEMPAT_WISATA);
    ...
    private void setUpFirebaseDatabase() {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Wisata, WisataViewHolder>(Wisata.class, R.layout.itemlist, WisataViewHolder.class, mDatabase) {
